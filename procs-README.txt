...
(A.2) In proc/proc.c:
    ...
    (b) In proc_cleanup(): 4 out of 7 pts
    (c) In do_waitpid(): 4 out of 6 pts
...
(C.3) wake me test, etc. (1 out of 2 pts)
(C.4) wake me uncancellable test, etc. (2 out of 2 pts)
(C.5) cancel me test, etc. (2 out of 4 pts)
(C.6) reparenting test, etc. (2 out of 2 pts)
(C.7) show race test, etc. (2 out of 3 pts)
